...
object DataModule {
    ...
    @Provides
    @Singleton // указание, что зависимости создаются один раз и используются во всём приложении
    ...
    // Прим. аннотация @ApplicationContext используется, т.к. создаваемый объект требует Android-контекста ->
    // ->  HabitDatabase должен существовать на протяжении всей жизни приложения
